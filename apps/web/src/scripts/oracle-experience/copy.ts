...
const messages: Record<OracleLocale, OracleCopy> = {
  en: {
    ...
    recentUsernamesTitle: 'Recent usernames',
    ...
    goBack: 'Go back',
    shareImageButton: 'Share or copy as Image',
    shareXButton: 'Share on X',
    shareImageProcessing: 'Rendering image...',
    copied: 'Copied',
    ...
    shareImageDownloaded: 'Reading image downloaded. Attach it in your post.',
    shareImageFailed: 'Unable to render reading image.',
    sharePopupBlocked: 'Popup blocked. Allow popups to share.',
  ...
  es: {
    ...
    recentUsernamesTitle: 'Usuarios recientes',
    ...
    goBack: 'Volver',
    shareImageButton: 'Comparte o copia como imagen',
    shareXButton: 'Compartir en X',
    shareImageProcessing: 'Renderizando imagen...',
    copied: 'Copiado',
    ...
    shareImageDownloaded: 'Imagen de lectura descargada. Adjuntala en tu publicacion.',
    shareImageFailed: 'No se pudo renderizar la imagen de la lectura.',
    sharePopupBlocked: 'El navegador bloqueo la ventana emergente. Habilita popups para compartir.',
